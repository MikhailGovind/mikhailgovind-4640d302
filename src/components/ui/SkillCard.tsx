...
const SkillCard = ({ title, icon, skills, className }: SkillCardProps) => {
  return (
    <div className={cn(
      "bg-card text-card-foreground rounded-lg border border-border shadow-md p-6 hover:shadow-lg transition-shadow h-full",
      className
    )}>
      <div className="flex items-center mb-4 text-portfolio-primary">
        <div className="mr-3 animate-wave">{icon}</div>
