...
export const softSkills = [
  ...
  },
  {
    ...
    description: "Able to clearly convey design ideas across disciplines (art, dev, education), ensuring alignment between gameplay, learning objectives, and technical constraints."
  },
  {
    skill: "User-Centered Thinking",
    description: "Skilled at designing with learners and users in mind, considering accessibility, pacing, and engagement in educational environments."
  },
  {
